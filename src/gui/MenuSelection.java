...
import listener.copy.ButtonAddListener;
import listener.copy.ButtonViewListener;
...
public class MenuSelection extends JPanel {
	...
	public MenuSelection(WindowFrame windowFrame) {
		...
		JButton button2 = new JButton("Edit Book");
		JButton button3 = new JButton("Delete Book");
		JButton button4 = new JButton("View a list of Book");
